...
#pragma region HID_USAGE_CAPABILITIES
        HID_BEGIN_LOGICAL_COLLECTION(),
            ...
            HID_USAGE_WORD(HID_USAGE_SCREEN_PLANE_CURVATURE),
            HID_FEATURE_STATIC_VALUE(),

            HID_USAGE_WORD(HID_USAGE_SCREEN_PLANE_TOP_LEFT),
            HID_BEGIN_PHYSICAL_COLLECTION(),
                HID_REPORT_COUNT(3),
                HID_USAGE_WORD(HID_USAGE_POSITION_X),
                HID_USAGE_WORD(HID_USAGE_POSITION_Y),
                HID_USAGE_WORD(HID_USAGE_POSITION_Z),
                HID_FEATURE_STATIC_VALUE(),
            HID_END_COLLECTION(),

            HID_USAGE_WORD(HID_USAGE_SCREEN_PLANE_TOP_RIGHT),
            HID_BEGIN_PHYSICAL_COLLECTION(),
                HID_REPORT_COUNT(3),
                HID_USAGE_WORD(HID_USAGE_POSITION_X),
                HID_USAGE_WORD(HID_USAGE_POSITION_Y),
            ...
            HID_USAGE_WORD(HID_USAGE_SCREEN_PLANE_BOTTOM_LEFT),
            HID_BEGIN_PHYSICAL_COLLECTION(),
                HID_REPORT_COUNT(3),
                HID_USAGE_WORD(HID_USAGE_POSITION_X),
                HID_USAGE_WORD(HID_USAGE_POSITION_Y),
